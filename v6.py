...
def store_passenger_request(record):
    with open("passenger_requests.jsonl", "a") as f_json:
...
class Passenger:
    ...
    def make_request(self):
        ...
        print(f"[Make Request] Passenger {self.passenger_id} created request {request['request_id']} for a {vehicle_type} ride.")
        return request
